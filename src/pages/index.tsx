...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`MyTest123`}</title>

        <meta
          name="description"
          content="Welcome to MyTest123 - Your Ultimate Online Destination for All Pet Needs. Simplifying Pet Care with a Click!"
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1472851294608-062f824d29cc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwZXQlMjBzdG9yZXxlbnwwfHx8fDE2OTIwMDk0MzV8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@mikepetrucci?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Mike Petrucci`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to MyTest123 - Your Ultimate Online Destination for All Pet Needs. Simplifying Pet Care with a Click!`}
            </Text>
            <Box
